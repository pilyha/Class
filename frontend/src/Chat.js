        ...
        if (msg.type === 'JOIN') {
            return (
                <ListItem key={msg.timeStamp}>
                    ...
                    <ListItemText>{msg.sender}</ListItemText>
                </ListItem>
            )
            ...
            return (
                <ListItem key={msg.timeStamp}>
                    <Avatar>{msg.sender[0].toUpperCase()}</Avatar>
                    <ListItemText>Hand upped</ListItemText>
                </ListItem>
            )
            ...
            return (
                <ListItem key={msg.timeStamp}>
                    ...
                    <ListItemText>{msg.sender} left class</ListItemText>
                </ListItem>
            )
        }
    }
                            ...
                            <Grid container>
                                <Grid item sm={1} xs={12} align="center">
                                    <Button variant="contained" color="primary"
                                            onClick={() => onSendMessage()}>Raise Up</Button>
                                </Grid>
                            </Grid>
                        </form>
                    </Grid>
